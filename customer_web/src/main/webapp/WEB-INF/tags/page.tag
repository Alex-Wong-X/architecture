...
<%@ attribute name="page" type="com.matrix.pageUtil.Page"
	required="true" description="分页对象"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>

<table width="100%" align="center">
	<tr>
		<td><span class="page-info">[共有记录${page.totalCount}条 /
				共分${page.totalPage}页 ， 当前是第 ${page.nowPage} 页]</span></td>
	</tr>
	<tr>
		<td><c:choose>
                ...
                <a href="#" onclick="turnPage(${page.nowPage - 1});"
						title="上一页">上一页</a>&nbsp;&nbsp;
            </c:otherwise>
			</c:choose> <c:choose>
